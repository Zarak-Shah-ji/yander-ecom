# Generated by Django 3.0.8 on 2020-08-26 17:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Shawls'), ('G', 'Gowns'), ('SC', 'Scarfs'), ('D', 'Decor'), ('SF', 'Saffron'), ('H', 'Honey'), ('T', 'Tea'), ('DF', 'Dry-Fruits')], max_length=2)),
